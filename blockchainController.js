const { resolve } = require("path");
 ...
 class BlockchainController {
       ...
       validateChainEP(){
        this.app.get("/validateChain",async(req,res) => {
            ...
            if(errorLog.length = !0){
                return res.status(500).send("Chain is full of errors and is wrong");
            }else {
                return res.status(200).send("All is well and fine");
            }
    ...
    requestMessgeOwnershipverification(address){
    ...
    getBlockByHeight(){
        this.app.get("/block/height/:height", async (req, res) => {
            if(req.params.height) {
                ...
                return res.ststus(404).send("Block Not Found! Review ihe Params!");
            }
        });
    }
